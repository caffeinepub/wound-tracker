...
import type { APIWoundMeasurement as _APIWoundMeasurement, ExternalBlob as _ExternalBlob, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getAllMeasurements(): Promise<Array<APIWoundMeasurement>> {
        if (this.processError) {
            try {
    ...
    async getMeasurement(arg0: string): Promise<APIWoundMeasurement | null> {
        if (this.processError) {
            try {
    ...
    async measureWound(arg0: string, arg1: ExternalBlob, arg2: number, arg3: number, arg4: number, arg5: number, arg6: number, arg7: number, arg8: number, arg9: number, arg10: number, arg11: number): Promise<APIWoundMeasurement> {
        if (this.processError) {
            try {
                const result = await this.actor.measureWound(arg0, await to_candid_ExternalBlob_n13(this._uploadFile, this._downloadFile, arg1), arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11);
                return from_candid_APIWoundMeasurement_n9(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
...
async function from_candid_APIWoundMeasurement_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _APIWoundMeasurement): Promise<APIWoundMeasurement> {
...
async function from_candid_opt_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_APIWoundMeasurement]): Promise<APIWoundMeasurement | null> {
    return value.length === 0 ? null : await from_candid_APIWoundMeasurement_n9(_uploadFile, _downloadFile, value[0]);
}
...
async function from_candid_record_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        redPercentage: value.redPercentage,
        area: value.area,
        perimeter: value.perimeter,
        diagnosis: value.diagnosis,
        textureSmoothness: value.textureSmoothness,
        exudateLevel: value.exudateLevel,
        timestamp: value.timestamp,
        edgeSharpness: value.edgeSharpness,
        image: await from_candid_ExternalBlob_n11(_uploadFile, _downloadFile, value.image),
        blackPercentage: value.blackPercentage,
        yellowPercentage: value.yellowPercentage,
        pinkPercentage: value.pinkPercentage
    };
}
...
async function from_candid_vec_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_APIWoundMeasurement>): Promise<Array<APIWoundMeasurement>> {
    return await Promise.all(value.map(async (x)=>await from_candid_APIWoundMeasurement_n9(_uploadFile, _downloadFile, x)));
}
